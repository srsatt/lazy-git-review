...
- [x] 11.4 Publish project-authored source and bundles as version `0.1.0` under EUPL-1.2: add canonical licence text and notice, update Cargo metadata and third-party notices, bundle both notice files, and verify version/licence identity inside each archive.
